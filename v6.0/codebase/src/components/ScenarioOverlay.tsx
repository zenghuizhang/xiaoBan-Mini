        ...
        {activeTab === 'imu' && (
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-1.5">
              ...
              <button onClick={() => navigateTo('thinking')} className={`flex items-center gap-1.5 px-2 py-2 rounded-md transition-all border ${itemClass}`}><MoveHorizontal size={12} /> <span className="text-[9px]">左倾 (Roll &gt; 15)</span></button>
              <button onClick={() => navigateTo('surprised')} className={`flex items-center gap-1.5 px-2 py-2 rounded-md transition-all border ${itemClass}`}><MoveHorizontal size={12} /> <span className="text-[9px]">右倾 (Roll &lt; -15)</span></button>
